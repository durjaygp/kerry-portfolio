                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="institute" class="form-control" placeholder="Institute Name" value="{{ old('institute', $education->institute) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="start_year" class="form-control" placeholder="YYYY" value="{{ old('start_year', $education->start_year) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="end_year" class="form-control" placeholder="YYYY Or Present" value="{{ old('end_year', $education->end_year) }}">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" cols="10" rows="3" class="form-control" placeholder="Brief description">{{ old('description', $education->description) }}</textarea>
